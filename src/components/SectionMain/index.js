  ...
  return (
    <section className="hero-section">
      <div className="container-fluid">
            ...
            <div className="col-md-9 custom-col-9">
              ...
              <div className="col-md-12 p-0">
                <div className="problemHeading">
                  ...
                  <h3 className="problemSub-h3 text-center">
                    こんなお悩みありませんか？
                  </h3>
                </div>
        ...
        <div className="row">
          <div className="col-md-9 custom-col-9 p-0">
            <section id="solution-section" className="solution-section">
                  ...
                  <div className="col-md-6 custom-padding">
                    <div className="sdh-right-text">
                      ...
                      <p className="sdh-p">
                        ...
                        技術ドメイン: AWS/Azure/GCP, Java, C#, Python,
                        Javascript ...など ビジネスドメイン: Automotive,
                  ...
                  <div className="process-content-left">
                    ...
                    <div className="process-step">
                      ...
                      <div className="step-content">
                        ...
                        <div className="step-content-desc">
                          <p>
                            現在の開発体制や成果イメージなどをヒアリング後、お客様に合った最適なご提案いたします。
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="process-step">
                      ...
                      <div className="step-content">
                        ...
                        <div className="step-content-desc">
                          <p>
                            ご契約後、キックオフミーティングを設定しプロジェクト開始となります。
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="col-md-12 mx-auto">
              ...
              <form className="main-contact-form">
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    className="form-control main-cntct-inputs"
                    id="name"
                  />
                </div>
                <div className="form-group">
                ...
                <div>
                  <img
                    className="contactCatImageSp"
                    src={contactCatImageSp}
                    alt="image"
                  />
              ...
              <img
                className="contactCatImagePc"
                src={contactCatImagePc}
                alt="contactCatImage"
              />
            </div>
          </div>
